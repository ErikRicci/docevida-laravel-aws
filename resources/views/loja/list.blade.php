        ...
        var setTotal = () => {
            ...
            for (var i = 0; i < Object.keys(carrinho).length; i++) {
                ...
                if (carrinho[Object.keys(carrinho)[i]]['qty'] > 0)
                    pedido += carrinho[Object.keys(carrinho)[i]]['qty'] + ' ' + carrinho[Object.keys(carrinho)[i]][
                        'self'
                    ] + ';';
            }
    ...
    @isset($products)
        <div class="card-deck" style="margin-left: 2vh; margin-right: 2vh">
            @foreach ($products as $index => $product)
                <div class="card" id="cardzin" style="border-top-left-radius: 12px; border-top-right-radius: 12px">
                    <button data-toggle="modal" data-target="#exampleModal{{ $product->nome_produto }}" class="card-link btn"
                        id="hover-image"><img
                            style="margin:auto; width: 100%; max-height: 500px; border-top-left-radius: 12px; border-top-right-radius: 12px"
                            class="card-img-top" src="{{ Storage::disk('s3')->url($product->thumbnail_produto) }}" alt="">
                    </button>
                    <div class="card-body">
                    ...
                    <div class="card-body">
                        <div style="width: 60%" class="input-group">
                            <input readonly style="font-size: 1.2rem" type="number" class="form-control" value="0" id="qtd{{ $index }}" placeholder="QTD."
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div id="carouselExampleControls{{ $product->nome_produto }}" class="carousel slide"
                                data-ride="carousel">
                                <div class="carousel-inner">
                                    <div style="background-color: rgb(180, 83, 66); height: 100px; text-align: center"
                                        class="carousel-item active">
                                        SABOR 1
                                    </div>
                                    <div style="background-color: rgb(247, 181, 105); height: 100px; text-align: center"
                                        class="carousel-item">
                                        SABOR 2
                                    </div>
                                    <div style="background-color: rgb(184, 126, 223); height: 100px; text-align: center"
                                        class="carousel-item">
                                        SABOR 3
                                    </div>
                                </div>
                                <a class="carousel-control-prev" href="#carouselExampleControls{{ $product->nome_produto }}"
                                    role="button" data-slide="prev">
                                    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                    <span class="sr-only">Anterior</span>
                                </a>
                                <a class="carousel-control-next" href="#carouselExampleControls{{ $product->nome_produto }}"
